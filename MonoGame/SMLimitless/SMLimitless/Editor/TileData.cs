...
{
	/// <summary>
	///   A class containing information about every available tile type in an
	///   assembly, as well as each variety of each tile.
	/// </summary>
	public sealed class TileData
	{
		...
		///   An enumerable containing default states for this tile.
		/// </param>
	...
	{
		/// <summary>
		///   Gets an integer representing the <see
		///   cref="Sprites.TileCollisionType" /> enum instance for this variety.
		/// </summary>
		...
		/// <summary>
		///   Gets an integer representing either a <see
		///   cref="Sprites.TileRectSolidSides" /> or <see
		///   cref="Sprites.TileTriSolidSides" /> enum instance, depending on
		///   what shape the tile has.
		/// </summary>
		...
		/// <summary>
		///   Gets the full type name of the tile for which this <see
		///   cref="TileDefaultState" /> is a variety of.
		/// </summary>
		public string TypeName { get; }
		...
		/// </summary>
		/// <param name="typeName">
		///   The full type name of the tile for which this <see
		///   cref="TileDefaultState" /> instance is a variety of.
		/// </param>
		/// <param name="solidStates">
		///   An integer representing either a <see
		///   cref="Sprites.TileRectSolidSides" /> or <see
		///   cref="Sprites.TileTriSolidSides" /> enum instance, depending on
		///   what shape the tile has.
		/// </param>
		/// <param name="collisionType">
		///   An integer representing the <see cref="Sprites.TileCollisionType"
		///   /> enum instance for this variety.
		/// </param>
		/// <param name="graphicsResource">
		///   The name of the graphics resource for this variety of tile.
		/// </param>
		/// <param name="state">The initial state for this variety of tile.</param>
		/// <param name="customData">
		///   A JSON object containing this variety's custom data.
		/// </param>
