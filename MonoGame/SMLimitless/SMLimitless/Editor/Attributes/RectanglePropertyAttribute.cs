...
{
    /// <summary>
    /// An attribute for properties of type <see cref="Microsoft.Xna.Framework.Rectangle"/>. 
    /// </summary>
	[AttributeUsage(AttributeTargets.Property, AllowMultiple = false, Inherited = true)]
	public sealed class RectanglePropertyAttribute : Attribute
	{
        /// <summary>
        ...
        /// cref="RectanglePropertyAttribute" /> class.
        /// </summary>
        /// <param name="name">
        ...
        /// </param>
		public RectanglePropertyAttribute(string name, string description)
		{
