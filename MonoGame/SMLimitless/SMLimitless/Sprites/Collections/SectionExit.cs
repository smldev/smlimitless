...
{
	/// <summary>
	///   An object in a section that players can use to teleport inside and
	///   between sections.
	/// </summary>
	public sealed class SectionExit
	{
		/// <summary>
		///   Keeps track of the state of an exit effect - the visual effect of a
		///   player moving into an exit.
		/// </summary>
		/// <remarks>
		...
		///
		///   Shift motion moves the player into the exit. It is either the
		///   second half of the effect or the entire effect.
		/// </remarks>
		private class ExitEffect
		{
			...
			/// <param name="exitHitbox">
			///   The hitbox of the exit being entered or left.
			/// </param>
			/// <param name="shiftDirection">
			///   The direction the player must move to enter or emerge from the exit.
			/// </param>
		...
		/// <summary>
		///   Gets the size of this section exit, guaranteed to be a multiple of
		///   <see cref="GameServices.GameObjectSize" />.
		/// </summary>
		...
		/// <returns>
		///   False if the sprite is not a player, this exit is not a source or a
		///   two-way exit, other players have entered a different exit, or if
		///   the player is not intersecting the exit. True if the player meets
		///   the above conditions and the user is pressing the correct button.
		/// </returns>
		...
		/// <summary>
		///   Places the player to emerge from the correct location in the
		///   section exit.
		/// </summary>
