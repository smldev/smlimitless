...
namespace SMLimitless.Sprites.Assemblies
{
	...
	/// </summary>
	/// <remarks>
	///   This type allows sprite and tiles to not need to explicitly reference Newtonsoft.Json.dll.
	/// </remarks>
	public class JsonHelper
	{
		...
		/// </summary>
		/// <param name="key">
		///   The name of the key containing the decimal number.
		/// </param>
		...
		/// </summary>
		/// <param name="key">
		///   The name of the key containing the double-precision floating point number.
		/// </param>
		/// <returns>
		///   A double-precision floating point number from the JToken.
		/// </returns>
		...
		/// </summary>
		/// <param name="key">
		///   The name of the key containing the single-precision floating
		///   pointer number.
		/// </param>
		/// <returns>
		///   A single-precision floating point number from the JToken.
		/// </returns>
		...
		/// </summary>
		/// <param name="key">
		///   The name of the key containing the unsigned integer.
		/// </param>
		...
		/// </summary>
		/// <param name="key">
		///   The name of the key containing the unsigned long integer.
		/// </param>
		...
		/// </summary>
		/// <param name="key">
		///   The name of the key containing the unsigned short integer.
		/// </param>
