...
namespace SMLimitless.Screens.Effects
{
	...
	public sealed class FadeEffect : IEffect
	{
		...
		/// <summary>
		///   Defines the effect direction for this effect. If the direction is
		///   forward, then fade to black. If backward, fade from black.
		/// </summary>
		...
		///   The direction in which to fade. Forward fades to black, backward
		///   fades from black.
		/// </param>
		...
		/// </summary>
		/// <param name="length">
		///   The number of frames this effect should run for.
		/// </param>
		/// <param name="direction">The direction to run this effect.</param>
		/// <param name="position">
		///   This parameter is meaningless for this IEffect implementer.
		/// </param>
		...
		/// <summary>
		///   Called when the effect is finished. Fires the EffectCompletedEvent.
		/// </summary>
