...
{
	/// <summary>
	///   A component that can be drawn and updated. It contains an internal
	///   object. Must be inherited.
	/// </summary>
	public abstract class Screen
	{
		...
		/// <summary>
		///   Gets or sets a value indicating whether this screen has had its
		///   content loaded.
		/// </summary>
		...
		/// <summary>
		///   Gets or sets a reference to a screen that is switched to once this
		///   screen exits.
		/// </summary>
