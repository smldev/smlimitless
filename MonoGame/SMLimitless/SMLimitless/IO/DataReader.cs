...
namespace SMLimitless.IO
{
	...
	public class DataReader
	{
		...
		/// <returns>
		///   The data relating to the key, or null if there is no matching key
		///   or section.
		/// </returns>
		...
		///   The name of the section from which to read.
		/// </param>
		...
		/// </summary>
		/// <param name="sectionName">
		///   The name of the section from which to read the data.
		/// </param>
		...
		/// </summary>
		/// <returns>
		///   The next collapsed data entry, or null if there is no next entry.
		/// </returns>
		...
		/// </summary>
		/// <returns>
		///   The next line of the file. Null if we're beyond the end.
		/// </returns>
		...
		/// </summary>
		/// <returns>
		///   The previous collapsed data entry, or null if there is no previous entry.
		/// </returns>
		...
		/// </summary>
		/// <returns>
		///   The previous line of the file, or null if the index is at the beginning.
		/// </returns>
		...
		/// <summary>
		///   Determines if a value is a collapsed data entry. Collapsed data
		///   entries contain commas but no equal signs.
		/// </summary>
		/// <param name="value">The value to check.</param>
		/// <returns>
		///   True if a comma is present (but no equal signs), false if otherwise.
		/// </returns>
