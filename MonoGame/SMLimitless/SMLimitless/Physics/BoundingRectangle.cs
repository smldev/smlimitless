...
namespace SMLimitless.Physics
{
	...
	public struct BoundingRectangle : ICollidableShape
	{
		...
		/// <summary>
		///   Gets a bounding rectangle at the origin of the world with zero
		///   width and height.
		/// </summary>
		...
		///   The <see cref="Rectangle" /> used to create this rectangle.
		/// </param>
		...
		/// </summary>
		/// <param name="input">
		///   A string containing four comma-delimited numbers.
		/// </param>
		...
		/// <summary>
		///   Returns a value indicating whether a point is above, below, to the
		///   left of, et cetera, of this rectangle.
		/// </summary>
		/// <param name="point">The point to check.</param>
		/// <returns>
		///   A <see cref="RectangularSpaceDivision" /> instance indicating where
		///   the point is with relation to this rectangle.
		/// </returns>
		...
		/// <param name="point">The point to check.</param>
		/// <returns>
		///   True if the point is within this rectangle, false if otherwise.
		/// </returns>
		...
		/// <returns>
		///   True if any part of the right triangle is intersecting this
		///   rectangle, false if otherwise.
		/// </returns>
		...
		/// <param name="point">The point to check.</param>
		/// <returns>
		///   True if the point is within or tangent to this rectangle, false if otherwise.
		/// </returns>
		...
		/// </summary>
		/// <returns>
		///   True if any component is equal to float.NaN, false if otherwise.
		/// </returns>
		public bool IsNaN()
		{
