...
{
	/// <summary>
	///   Defines several different scales for interpolators to use.
	/// </summary>
	public static class InterpolatorScales
	{
		/// <summary>
		///   Gets a cubic scale to interpolate between two values. This scale is
		///   similar to the quadratic scale, although it seems to accelerate
		///   more slowly.
		/// </summary>
		...
		///   The value starts increasing quickly, and loses speed as it
		///   approaches completion.
		/// </summary>
		public static InterpolatorScaleDelegate InverseQuadratic { get; private set; }

		/// <summary>
		///   Gets a scale that linearly interpolates between two values. The
		///   change in the value on every step is equal.
		/// </summary>
		public static InterpolatorScaleDelegate Linear { get; private set; }

		/// <summary>
		///   Gets a quadratic scale to interpolate between two values. The value
		///   starts increasing slowly, and gains more speed as it approaches completion.
		/// </summary>
		public static InterpolatorScaleDelegate Quadratic { get; private set; }

		/// <summary>
		///   Gets a smooth step scale to interpolate between two values. The
		///   value will start increasing slowly, accelerate, and then slow down
		...
		/// <summary>
		///   Applies the cubic scale to a certain amount of progress. Only use
		///   for progress values less than 1.
		/// </summary>
		...
		/// <summary>
		///   Applies the inverse quadratic scale to a certain amount of
		///   progress. Only use for progress values less than 1.
		/// </summary>
		/// <param name="progress">The original progress.</param>
		/// <returns>
		///   Return 1 minus the inverse (1 minus the progress) squared.
		/// </returns>
		...
		/// <summary>
		///   Applies the quadratic scale to a certain amount of progress. Only
		///   use for progress values less than 1.
		/// </summary>
		/// <param name="progress">The original progress.</param>
		...
		/// <summary>
		///   Applies the smooth step scale to a certain amount of progress. Only
		///   use for progress values less than 1.
		/// </summary>
		/// <param name="progress">The original progress.</param>
		/// <returns>
		///   Returns the progress, multiplied by itself, multiplied by 3 less
		///   than twice the progress.
		/// </returns>
