...
namespace SMLimitless.Physics
{
	...
	public struct SectionAutoscrollSettings
	{
		...
		/// <summary>
		///   Gets the name of the path that this section is automatically
		///   scrolling along.
		/// </summary>
		/// <exception cref="InvalidOperationException">
		///   Thrown in the getter and setter if this section is not
		///   automatically scrolling along a path.
		/// </exception>
		...
		///   cref="SectionAutoscrollSettings" /> struct.
		/// </summary>
		/// <param name="scrollType">
		///   A value indicating how the section automatically scrolls.
		/// </param>
		/// <param name="speed">
		///   A value indicating how fast the section automatically scrolls.
		/// </param>
		/// <param name="pathName">
		///   The name of the path that this section is automatically scrolling along.
		/// </param>
