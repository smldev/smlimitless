...
namespace SMLimitless.Extensions
{
	...
	public static class SpriteBatchExtensions
	{
		...
		/// <param name="color">
		///   The color used to "shade" the texture. Use Color.White for no shading.
		/// </param>
		...
		/// </summary>
		/// <param name="batch">
		///   The SpriteBatch used to draw the rectangle outline.
		/// </param>
		...
		/// </summary>
		/// <param name="batch">
		///   The SpriteBatch used to draw this rectangle outline.
		/// </param>
