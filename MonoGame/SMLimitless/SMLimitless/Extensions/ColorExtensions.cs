...
namespace SMLimitless.Extensions
{
	...
	public static class ColorExtensions
	{
		...
		public static Color FromPackedValue(uint packed)
		{
			...
			int green = (int)((packed & 0x00FF0000) >> 16);
			int blue = (int)((packed & 0x0000FF00) >> 8);
			int alpha = (int)(packed & 0x000000FF);
		...
		///   A JSON token containing four comma-delimited integers between 0 and 255.
		/// </param>
