...
namespace SMLimitless.Extensions
{
	...
	{
		/// <summary>
		///   Eagerly separates an enumerable into lists of sublists with given a
		///   selector function. Each sublist contains all the items that have
		...
		/// <param name="value">
		///   A selector function that is used to separate the enumerable.
		/// </param>
		/// <returns>
		///   A list of lists, each list containing all the items for which the
		///   selector function returned the same value.
		/// </returns>
		...
		/// <summary>
		///   Enumerates over every item in an enumerable and performs a given
		///   action on it.
		/// </summary>
