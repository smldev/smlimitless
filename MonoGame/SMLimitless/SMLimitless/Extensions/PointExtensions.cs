...
namespace SMLimitless.Extensions
{
	...
	{
		/// <summary>
		///   Converts a <see cref="string" /> with the form "x,y;x,y" into a
		///   <see cref="List{T}" /> of <see cref="Point" /> instances.
		/// </summary>
		/// <param name="pointsString">A string of points.</param>
		/// <returns>
		///   A list containing the points deserialized from the string.
		/// </returns>
		...
		/// <summary>
		///   Converts an enumerable containing <see cref="Point" /> instances
		///   into a <see cref="string" /> of form "x,y;x,y" with no trailing semicolon.
		/// </summary>
		/// <param name="points">
		///   An enumerable containing the points to be serialized.
		/// </param>
		/// <param name="sorted">
		///   A parameter that, if True, will sort the points by X value then Y
		///   value before serializing them.
		/// </param>
