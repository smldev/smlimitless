...
namespace SMLimitless.Extensions
{
	...
	public static class StringExtensions
	{
		...
		/// <param name="position">
		///   The position on the screen to draw it at.
		/// </param>
		/// <param name="scale">
		///   Optional, default is 1. The size of the text to draw.
		/// </param>
		...
		/// <summary>
		///   Draws a string in the color white to the screen at the position of
		///   (16, 16) using the default font.
		/// </summary>
		/// <param name="value">The string to draw.</param>
		...
		/// <summary>
		///   Removes INI comments from INI-styled string arrays. A comment
		///   begins with a semicolon (;), and can start a line or be inline.
		/// </summary>
		/// <param name="input">
		///   A list of strings (e.g. a file) from which to extract comments.
		/// </param>
		...
		/// </summary>
		/// <param name="input">
		///   A string array (e.g. a file) to remove comments from.
		/// </param>
		...
		/// <returns>
		///   A deep copy of the string, or null if the string is null.
		/// </returns>
