...
namespace SMLimitless.Input
{
	...
	{
		/// <summary>
		///   The "up" action. An example of usage is a player holding Up to
		///   enter a pipe.
		/// </summary>
		Up,

		/// <summary>
		///   The "down" action. An example of usage is a player holding Down to duck.
		/// </summary>
		Down,

		/// <summary>
		///   The "left" action. An example of usage is a player holding Left to
		///   move left.
		/// </summary>
		Left,

		/// <summary>
		///   The "right" action. An example of usage is a player holding Right
		///   to move right.
		/// </summary>
		Right,

		/// <summary>
		///   The "jump" action. An example of usage is a player pressing Jump to
		///   jump into the air.
		/// </summary>
		Jump,

		/// <summary>
		///   The "spin jump" action. An example of usage is a player pressing
		///   Spin Jump to perform a spin jump.
		/// </summary>
		SpinJump,

		/// <summary>
		///   The "run" action. An example of usage is a player pressing Run to
		///   begin moving faster.
		/// </summary>
		Run,

		/// <summary>
		///   The "alternate run" action. Performs much the same action as the
		///   "run" action, but can be set do other things.
		/// </summary>
		AltRun,

		/// <summary>
		///   The "pause" action. An example of usage is a user pressing Pause to
		///   pause the game.
		/// </summary>
		Pause
	}
	...
	/// <summary>
	///   Provides access to current and previous keyboard and mouse states for
	///   use in input. This class is mostly built from RCIX's XNA InputManager
	///   class that he posted on Stack Exchange.
	/// </summary>
	public static class InputManager
	{
		...
		/// <summary>
		///   Gets the current velocity of the mouse, determined as the
		///   difference in the positions of the current and the last mouse states.
		/// </summary>
		...
		/// <summary>
		///   Gets the current velocity of the mouse's scroll wheel, determined
		///   by the difference of the current and the last scroll wheel positions.
		/// </summary>
		...
		/// <summary>
		///   Determines if an input action was pressed in the current frame and
		///   the last.
		/// </summary>
		...
		/// <summary>
		///   Returns a value indicating whether the mouse cursor is within the
		///   bounds of the window.
		/// </summary>
		/// <returns>
		///   True if the cursor is within the window, false if it is not.
		/// </returns>
		...
		/// <summary>
		///   Determines if an input action was pressed in the current frame but
		///   not the last.
		/// </summary>
		/// <param name="action">The action to check.</param>
		...
		/// <summary>
		///   Determines if an input action was pressed in the last frame but not
		///   the current.
		/// </summary>
		/// <param name="action">The action to check.</param>
		...
		/// <summary>
		///   Determines if a mouse button was pressed on the last frame but not
		///   this one.
		/// </summary>
		/// <param name="button">The button to check.</param>
		...
		/// <summary>
		///   Updates the keyboard and mouse states. The current states becomes
		///   the last state.
		/// </summary>
