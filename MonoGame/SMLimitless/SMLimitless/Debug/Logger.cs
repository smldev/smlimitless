...
{
	/// <summary>
	///   Provides a global method to log debug, warning, and error messages to a
	///   form, or save logs to a file on disk.
	/// </summary>
	public static class Logger
	{
		...
		/// <summary>
		///   Gets or sets a value indicating whether logs should be displayed in
		///   the debug form when sent.
		/// </summary>
		public static bool DisplayLogsInDebugForm { get; set; }

		/// <summary>
		///   Gets or sets a value indicating whether logging is enabled. If
		///   logging is disabled, all calls to log methods are ignored.
		/// </summary>
		...
		/// <summary>
		///   Adds a message to the log and prepends it with the current time and
		///   log level. Additionally, sends the message to the DebugForm if the
		///   <see cref="DisplayLogsInDebugForm" /> property is set.
		/// </summary>
		/// <param name="level">
		///   The level of message (Information, Warning, Error) at which this
		///   log message is.
		/// </param>
