...
{
	/// <summary>
	///   Defines a visual effect. These can be used, for example, to switch
	///   between screens.
	/// </summary>
	public interface IEffect
	{
		...
		/// </summary>
		/// <param name="length">
		///   The length in frames that this effect will run for.
		/// </param>
		/// <param name="direction">
		///   An EffectDirection that defines whether the effect works "forward"
		///   or "backward.
		/// </param>
		/// <param name="position">
		///   The position on the screen to draw this effect.
		/// </param>
		/// <param name="color">The color of this effect.</param>
