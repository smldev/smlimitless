...
namespace SMLimitless.Sounds
{
	...
	{
		/// <summary>
		///   A dictionary of loaded sounds. The string key is the sound's name,
		///   and the Sound value is the loaded sound.
		/// </summary>
		...
		/// </summary>
		/// <param name="name">
		///   The name of the sound. This will be used to access the sound.
		/// </param>
		/// <param name="filePath">
		///   The path to an MP3 file containing the sound.
		/// </param>
