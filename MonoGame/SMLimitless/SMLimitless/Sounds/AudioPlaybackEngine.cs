...
namespace SMLimitless.Sounds
{
	...
	{
		/// <summary>
		///   Gets an instance of the <see cref="AudioPlaybackEngine" /> for
		///   global usage.
		/// </summary>
		public static readonly AudioPlaybackEngine Instance = new AudioPlaybackEngine(44100, 2);

		// Credit to Mark Heath (NAudio author) http://mark-dot-net.blogspot.com/2014/02/fire-and-forget-audio-playback-with.html
		...
		/// <summary>
		///   Initializes a new instance of the <see cref="AudioPlaybackEngine"
		///   /> class.
		/// </summary>
		/// <param name="sampleRate">
		///   How many samples should be played in a second.
		/// </param>
		/// <param name="channelCount">
		///   How many channels of sound should be played.
		/// </param>
