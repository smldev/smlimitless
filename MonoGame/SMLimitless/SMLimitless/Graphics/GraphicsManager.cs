...
namespace SMLimitless.Graphics
{
	...
	public static class GraphicsManager
	{
		...
		/// <summary>
		///   A dictionary containing all loaded graphics objects and their image
		///   file paths.
		/// </summary>
		private static Dictionary<string, IGraphicsObject> loadedObjects;

		/// <summary>
		///   A dictionary containing a list of all loaded textures and their
		///   file paths.
		/// </summary>
		...
		/// </summary>
		/// <param name="texture">
		///   The original texture; the one to crop out of.
		/// </param>
		...
		public static Texture2D LoadTextureFromFile(string filePath)
		{
			...
			{
				throw new FileNotFoundException(string.Format("The file at {0} does not exist.", filePath), nameof(filePath));
			}
