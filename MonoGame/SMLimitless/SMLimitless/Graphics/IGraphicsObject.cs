...
namespace SMLimitless.Graphics
{
	...
	{
		/// <summary>
		///   Clones this graphics object. The texture(s) are not cloned, merely
		///   their reference is copied.
		/// </summary>
		...
		/// </summary>
		/// <param name="position">
		///   The position on the screen to draw this object at.
		/// </param>
		/// <param name="color">
		...
		/// </summary>
		/// <param name="position">
		///   The position on the screen to drop this object at.
		/// </param>
		...
		/// <summary>
		///   Loads a frame of this graphics object that can be used in the level
		///   editor form.
		/// </summary>
