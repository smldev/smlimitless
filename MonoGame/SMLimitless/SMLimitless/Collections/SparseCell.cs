...
namespace SMLimitless.Collections
{
	...
	public sealed class SparseCell<T> where T : IPositionable2
	{
		...
		/// </summary>
		/// <param name="items">
		///   A collection of items to place within this cell.
		/// </param>
		/// <param name="cCellSize">The size of this cell.</param>
		/// <param name="cCellNumber">
		///   The two-dimensional, zero-based index of this cell.
		...
		/// <returns>
		///   True if the item intersects this cell (including a tangent,
		///   edges-only intersection), False if it does not.
		/// </returns>
