...
{
	/// <summary>
	///   Provides a generic hierarchy collection. Please note that this class
	///   itself represents a node in a hierarchy, and contains a collection of
	///   child nodes.
	/// </summary>
	...
	public class Hierarchy<T> where T : class
	{
		...
		/// <summary>
		///   Gets the next level up in the hierarchy. Use .Add() to assign a parent.
		/// </summary>
		...
		/// </summary>
		/// <param name="node">
		///   The node, optionally containing some data, to add to this node.
		/// </param>
		...
		/// <returns>
		///   A new <see cref="Hierarchy{T}" /> instance containing the data.
		/// </returns>
		...
		/// <summary>
		///   Calculates the zero-based depth of this node in the hierarchy. This
		///   method is recursive, and will become slower with larger hierarchies.
		/// </summary>
		...
		/// <summary>
		///   Removes a specified node from this hierarchy node. This method is
		///   recursive, and will become slower with larger hierarchies.
		/// </summary>
		/// <param name="node">The node to remove.</param>
		/// <exception cref="Exception">
		///   Thrown in the node is not contained within this hierarchy node.
		/// </exception>
		...
		/// <summary>
		///   Searches a hierarchy from this node down. This method is recursive,
		///   and will become slower with larger hierarchies.
		/// </summary>
		/// <param name="data">The data to search for.</param>
		/// <returns>
		///   The node containing the data, or null if there is no match.
		/// </returns>
